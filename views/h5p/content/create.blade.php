    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <form method="POST" action="{{ route('h5p.store') }}" class="form-horizontal" enctype="multipart/form-data"
                    id="laravel-h5p-form">
                    @csrf
                    ...
                    <fieldset>
                        ...
                        <div class="form-group {{ $errors->has('title') ? 'has-error' : '' }}">
                            ...
                            <div class="col-md-9">
                                ...
                                <x-form.input name="title" :value="old('title')" class="form-control"
                                        ...
                                        <ul class="list-unstyled">
                                            ...
                                            <li>
                                                <label>
                                                    ...
                                                    <x-form.checkbox name="frame" :checked="$display_options[H5PCore::DISPLAY_OPTION_FRAME]"
                                                        class="h5p-visibility-toggler"
                                                        data-h5p-visibility-subject-selector=".h5p-action-bar-buttons-settings"
                                                        id="laravel-h5p-frame" :value="old('title')" />
                                            ...
                                            @if (isset($display_options[H5PCore::DISPLAY_OPTION_DOWNLOAD]))
                                                <li>
                                                    <label>
                                                        <x-form.checkbox name="download" :checked="$display_options[H5PCore::DISPLAY_OPTION_DOWNLOAD]"
                                                            class="h5p-visibility-toggler"
                                                            data-h5p-visibility-subject-selector=".h5p-action-bar-buttons-settings"
                                                            id="laravel-h5p-title" :value="old('title')" />
                                            ...
                                            @if (isset($display_options[H5PCore::DISPLAY_OPTION_EMBED]))
                                                <li>
                                                    <label>
                                                        <x-form.checkbox name="embed" :checked="$display_options[H5PCore::DISPLAY_OPTION_EMBED]"
                                                            class="h5p-visibility-toggler"
                                                            data-h5p-visibility-subject-selector=".h5p-action-bar-buttons-settings"
                                                            id="laravel-h5p-title" :value="old('title')" />
                                            ...
                                            @if (isset($display_options[H5PCore::DISPLAY_OPTION_COPYRIGHT]))
                                                <li>
                                                    <label>
                                                        ...
                                                        <x-form.checkbox name="copyright" :checked="$display_options[H5PCore::DISPLAY_OPTION_COPYRIGHT]"
                                                            class="h5p-visibility-toggler"
                                                            data-h5p-visibility-subject-selector=".h5p-action-bar-buttons-settings"
                                                            id="laravel-h5p-title" :value="old('title')" />
